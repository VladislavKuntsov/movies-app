...
export default class MovieItem extends Component {
    ...
    render() {
        const { poster_path: posterPath, overview, rating, vote_average: voteAverage, release_date: releaseDate, genre_ids: genreIds, original_title: originalTitle, id} = this.props;
